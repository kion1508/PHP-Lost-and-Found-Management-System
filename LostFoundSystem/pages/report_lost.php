...
if (isset($_POST['submit'])) {
    ...
    $uploadpath="uploads_lost/".$newfilename;
    ...
    while (true) {
        ...
        $random_number = mt_rand(10000, 99999);
        $generated_code = $prefix . $random_number;
        $check = mysqli_query($conn, "SELECT id FROM lost_items WHERE report_lost_id = '$generated_code' LIMIT 1");
    ...
    $sql="INSERT INTO lost_items (report_lost_id,description,item_name,contact_no,last_loc,email,category,date_lost,image,reporter_id) VALUES ('$generated_code','$description' ,'$item_name' ,'$user_phone' ,'$location','$user_email','$category','$date_lost','$newfilename','$reporter_id')";
...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            <div>
                <h1 class="page-title"><i class="fas fa-question-circle text-warning me-2"></i>Report Lost Item</h1>
        ...
        <div class="card fade-in">
            <div class="card-header">
                <i class="fas fa-edit me-2"></i>Lost Item Details
            </div>
            <div class="card-body">
